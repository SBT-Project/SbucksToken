...
int nCoinbaseMaturity = 29; // 30 in total
...
const string strMessageMagic = "SbucksToken Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 15;
    }
    else if (pindexBest->nHeight < 20000)
    {
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 35;
    }
    else if (pindexBest->nHeight < 40000)
    {
    ...
    {
        nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8) * 45;
    }
    else if (pindexBest->nHeight < 50000)
    {
...
{
    RenameThread("sbuckstoken-loadblk");
