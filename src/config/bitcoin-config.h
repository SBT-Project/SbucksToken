...
#define PACKAGE_BUGREPORT "sbuckstoken2018@outlook.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SbucksToken"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SbucksToken 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sbuckstoken"
